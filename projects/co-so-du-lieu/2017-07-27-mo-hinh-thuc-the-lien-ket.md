...
<p>Các kiểu thực thể và các tập thực thể: Một cơ sở dữ liệu thường chứa những
...
liệu. Hình dưới đây minh họa các kiểu thực thể NHÂNVIÊN, CÔNGTY và các tập thực
thể tương ứng.</p>
...
![Hình 2](\assets\img\csdl\kieuLienKet.PNG) **Thể hiện liên kết** ![Hình 3](\assets\img\csdl\theHienLienKet.PNG)
